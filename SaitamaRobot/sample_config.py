...
class Config(object):
    ...
    TOKEN = "1612619358:AAFswr7uF3x_VzpCh62QuvZCWjwLHunzvNw"  #This var used to be API_KEY but it is now TOKEN, adjust accordingly.
    ...
    SUPPORT_CHAT = 'MidoriyaSupport'  #Your own group for support, do not add the @
